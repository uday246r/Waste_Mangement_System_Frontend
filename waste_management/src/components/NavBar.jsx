    ...
    <nav className="bg-gradient-to-r from-teal-600 to-green-600 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Logged In User/Company Dropdown */}
          {currentUser && (
            <div className="flex items-center">
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg z-20 transform opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition duration-200 ease-in-out">
                  <div className="py-2">
                    ...
                    <Link to="/profile" className="flex items-center px-4 py-3 hover:bg-gray-50">
                    ...
                    {currentUser && (
                      <>
                        <Link to="/videos" className="flex items-center px-4 py-3 hover:bg-gray-50">
                          <svg className="h-5 w-5 text-gray-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
                        ...
                        <Link to="/connections" className="flex items-center px-4 py-3 hover:bg-gray-50">
                          <svg className="h-5 w-5 text-gray-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
